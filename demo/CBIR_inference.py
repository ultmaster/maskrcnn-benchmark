...
encoder.FLOAT_REPR = lambda o: format(o, '.9f')
...
from torchvision import transforms as T, models, transforms
...
if __name__ == "__main__":
    ...
    for file_name in sorted(os.listdir("CBIR/images")):
        ...
        bbox_prediction = [[int(t) for t in v] for v in bbox.bbox.numpy()]
        labels_prediction = [coco_demo.categories[i] for i in bbox.extra_fields["labels"]]
